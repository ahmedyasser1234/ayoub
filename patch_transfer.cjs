...
const transferData = {
  en: {
    ...
    privateDesc: "Hyundai, Chery, Lancer or similar. Perfect for up to 4 passengers.",
    minibus: "Minibus (Van)",
  ...
  ar: {
    ...
    privateDesc: "هيونداي، شيري، لانسر أو ما شابه. مثالية حتى 4 ركاب.",
  ...
  ru: {
    ...
    privateDesc: "Hyundai, Chery, Lancer или аналогичные. До 4 пассажиров.",
  ...
  it: {
    ...
    privateDesc: "Hyundai, Chery, Lancer o simili. Ideale per un massimo di 4 passeggeri.",
