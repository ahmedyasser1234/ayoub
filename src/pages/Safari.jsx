        ...
        <div className="container">
          ...
          <div className="safari-gallery-preview section" style={{ marginTop: '50px' }}>
            ...
            <div className="grid grid-3" style={{ gap: '15px' }}>
              <img src={`${import.meta.env.BASE_URL}images/image copy 14.webp`} alt="Gallery 1" style={{ width: '100%', borderRadius: '15px', aspectRatio: '3/4', objectFit: 'cover' }}  loading="lazy" decoding="async" />
              <img src={`${import.meta.env.BASE_URL}images/image copy 15.webp`} alt="Gallery 2" style={{ width: '100%', borderRadius: '15px', aspectRatio: '3/4', objectFit: 'cover' }}  loading="lazy" decoding="async" />
              <img src={`${import.meta.env.BASE_URL}images/image copy 16.webp`} alt="Gallery 3" style={{ width: '100%', borderRadius: '15px', aspectRatio: '3/4', objectFit: 'cover' }}  loading="lazy" decoding="async" />
              <img src={`${import.meta.env.BASE_URL}images/image copy 2.webp`} alt="Gallery 4" style={{ width: '100%', borderRadius: '15px', aspectRatio: '3/4', objectFit: 'cover' }}  loading="lazy" decoding="async" />
              <img src={`${import.meta.env.BASE_URL}images/image copy 10.webp`} alt="Gallery 5" style={{ width: '100%', borderRadius: '15px', aspectRatio: '3/4', objectFit: 'cover' }}  loading="lazy" decoding="async" />
              <img src={`${import.meta.env.BASE_URL}images/image copy 11.webp`} alt="Gallery 6" style={{ width: '100%', borderRadius: '15px', aspectRatio: '3/4', objectFit: 'cover' }}  loading="lazy" decoding="async" />
            </div>
